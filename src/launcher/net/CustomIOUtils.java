...
public class CustomIOUtils {
     ...
     * before using {@link CustomIOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
     ...
     * @see CustomIOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
    ...
    public static byte[] toByteArray(URI uri) throws IOException {
        return CustomIOUtils.toByteArray(uri.toURL());
    }
    ...
    public static byte[] toByteArray(URL url) throws IOException {
        ...
        try {
            return CustomIOUtils.toByteArray(conn);
        } finally {
            close(conn);
        }
    }
    ...
    public static byte[] toByteArray(URLConnection urlConn) throws IOException {
        ...
        try {
            return CustomIOUtils.toByteArray(inputStream);
        } finally {
            inputStream.close();
        }
    }
     ...
     * @since 1.1
     */
    public static int copy(InputStream input, OutputStream output, ProgressListener listener) throws IOException {
        long count = copyLarge(input, output,listener);
     ...
     * @since 1.3
     */
    public static long copyLarge(InputStream input, OutputStream output, ProgressListener listener)
            throws IOException {
        return copyLarge(input, output, new byte[DEFAULT_BUFFER_SIZE],listener);
    }
     ...
     * @since 2.2
     */
    public static long copyLarge(InputStream input, OutputStream output, byte[] buffer, ProgressListener listener)
            throws IOException {
        long count = 0;
        int n = 0;
